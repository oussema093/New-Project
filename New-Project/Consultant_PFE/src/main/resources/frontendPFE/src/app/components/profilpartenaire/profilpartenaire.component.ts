...
@Component({
  selector: 'app-profilpartenaire',
  templateUrl: './profilpartenaire.component.html',
  styleUrls: ['./profilpartenaire.component.css']
})
export class ProfilpartenaireComponent implements OnInit {
