...
@Component({
  selector: 'app-listconsultantss',
  templateUrl: './listconsultantss.component.html',
  styleUrls: ['./listconsultantss.component.css']
})
export class ListconsultantssComponent implements OnInit {
  consultant:any;
